...
# User.create!([
#   {name: "some name", email: "some_email@email.com", password: "password", password_confirmation: "password"},
#   {name: "some name 2", email: "some_email_2@email.com", password: "password", password_confirmation: "password"}
# ])
...
ProductCategory.create(category_id: 5, product_id: 5)
ProductCategory.create(category_id: 5, product_id: 6)
